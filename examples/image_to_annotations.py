...
def image_to_annotations(img_fn: str, out_dir: str) -> None:
    ...
    # upload_result = cloudinary.uploader.upload(image_bytes, format="png")
    # image_url = upload_result['secure_url']
    # print("Uploaded img URL:", image_url)
...
# Convert YAML content to a string
    ...
    # right: 651,
    # bottom: 971'''
    # bounding_box = yaml.dump(yaml_content)
    # print(bounding_box)
    ...
    # response = upload(yaml_file, resource_type='raw', format='yaml')
    # bounding_box_yaml = response['secure_url']
    # print(f"Uploaded YAML file URL: {bounding_box_yaml}")
    ...
    # image_bytes = buffer.tobytes()
    # upload_result_texture = cloudinary.uploader.upload(image_bytes, format="png")
    # image_url = upload_result_texture['secure_url']
    # print("Uploaded img URL:", image_url)
    ...
    # image_bytes = buffer.tobytes()
    # upload_result_mask = cloudinary.uploader.upload(image_bytes, format="png")
    # image_url = upload_result_mask['secure_url']
    # print("Uploaded img URL:", image_url)
    ...
    # char_cfg_yaml = yaml.dump(char_cfg)
    # print(char_cfg_yaml)

    # response = upload(yaml_file, resource_type='raw', format='yaml')
    # char_cfg_yaml = response['secure_url']
    # print(f"Uploaded YAML file URL: {char_cfg_yaml}")
    ...
    # _, buffer = cv2.imencode('.png', joint_overlay)
    # image_bytes = buffer.tobytes()
    # upload_result_joint_overlap = cloudinary.uploader.upload(image_bytes, format="png")
